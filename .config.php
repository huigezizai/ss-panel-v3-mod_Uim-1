...
$System_Config['email_verify_iplimit']='10';      			//单IP可请求验证码次数（上面那个周期内）


//已注册用户设置------------------------------------------------------------------
#基础
$System_Config['checkinMin'] = '100';       					//用户签到签到最少流量 单位MB
$System_Config['checkinMax'] = '500';       					//用户签到签到最多流量
...
$System_Config['auto_clean_min_money']='1';      			//自动清理时余额低于多少的0级用户会被清理
...
$System_Config['version']='0';	//仅当涉及【需要修改config以外的文件】时才需要+1
